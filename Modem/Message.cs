...
namespace Vultrue.Communication
{
    ...
    public class Message
    {
        ...
        /// 目的/源地址
        /// </summary>
        public string TerminalAddress { get; protected set; }

        /// <summary>
        /// 服务中心时间戳
        /// </summary>
        public string ServiceCenterTimeStamp { get; protected set; }
        ...
        public Message(string mobileNum, string userData)
        {
        ...
        /// <param name="pdustr">短信内容(tpdu)</param>
